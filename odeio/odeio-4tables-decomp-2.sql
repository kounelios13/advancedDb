...
insert into daskalos values ('D-1', 'SERPANOS STELIOS', 'ENX-1');
insert into daskalos values ('D-2', 'APOXHS GIANNIS', 'ENX-1');
insert into daskalos values ('D-3', 'PAGKOS KOSTAS', 'ENX-2');
