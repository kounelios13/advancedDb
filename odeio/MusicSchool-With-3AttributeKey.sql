...
foreign key (kodikos_organou) references organo (kodikos_organou),
primary key (kodikos_daskalou, kodikos_spoudastn, kodikos_organou)
);
...
insert into xreosn values ('D-1', 'S-01', 'ENX-1', 17);
insert into xreosn values ('D-2', 'S-02', 'ENX-1', 16);
insert into xreosn values ('D-3', 'S-03', 'ENX-1', 17);
insert into xreosn values ('D-1', 'S-03', 'ENX-1', 12);
